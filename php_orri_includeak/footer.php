    <footer>
        ...
        <div class="orri-oin-nabigazioa">
            ...
            <a href="<?php echo $bide_absolutua; ?>php_orri_hasierakoak/kontaktua.php">Kontaktua</a>
            <a href="<?php echo $bide_absolutua; ?>php_orri_hasierakoak/login.php">Saioa Hasi</a>
        </div>
