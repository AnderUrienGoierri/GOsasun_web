...
<body class="<?php echo $body_class ?? 'panel-gorputza'; ?>">
    <header class="panel-goiburua">
        ...
        <ul class="nabigazio-estekak">
            ...
            <li><a href="datuak.php" <?php echo (isset($current_page) && $current_page === 'datuak') ? 'class="aktiboa"' : ''; ?>>Nire Datuak</a></li>
            <li><a href="neurketak.php" <?php echo (isset($current_page) && $current_page === 'neurketak') ? 'class="aktiboa"' : ''; ?>>Neurketak</a></li>
